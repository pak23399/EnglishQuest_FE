...
function BadgeContainer({
  ...
  return <div className={cn('relative w-fit', className)} {...props} />;
}

interface BadgeIndicatorProps extends React.HTMLAttributes<HTMLDivElement> {
  align?: 'top-right' | 'bottom-right' | 'top-left' | 'bottom-left';
}
...
function BadgeIndicator({
  ...
  const positionClasses: Record<typeof align, string> = {
  ...
  return (
    <div
      className={cn('absolute', positionClasses[align], className)}
      {...props}
    />
  );
}
